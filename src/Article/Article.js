...
export default class Article extends Component {
  ...
  componentDidMount() {
    ...
    api.posts
      .read(
        { slug: this.props.match.params.articleID, include: "tags,authors" },
    ...
    if (this.state.post.image)
      image = (
        <img
          alt=""
          className={
            this.state.isMobile ? "articleMobileImage" : "articleImage"
          }
          ...
          <div className="mobileArticle">
            ...
            <div className="pa4">
              ...
              <Fade>
                ...
                />
                <div className="articleContent pb3">
                  Written By: {this.state.post.author}
                </div>
              ...
              <div
                style={{ width: "100%" }}
                className="pv3 flex flex-row justify-between"
              >
                <FacebookShareButton
                  children={<FacebookIcon size={40} round={true} />}
                  url={`${url}/article/${this.props.match.params.articleID}`}
                />
                <TwitterShareButton
